...
// const stuff: string[] | number[] = ["Hello", "World"];
// const stuff: string[] | number[] = [10, 20];
// const stuff: Array<number> | Array<string> = ["Hello", "World"];
...
const colors: (RGBColor | HSLColor)[] = [{ b: 2, g: 2, r: 3, l: 2, s: 2 }];
...
function greet(name: string | string[]): string {
  let arrOfNameGreat: string = "";

  if (typeof name === "string") {
    return `Hello, ${name}`;
  } else {
    for (const n of name) {
      arrOfNameGreat += `Hello, ${n}\n`;
    }
  }
